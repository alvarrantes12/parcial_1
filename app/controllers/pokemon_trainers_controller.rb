class PokemonTrainersController < ApplicationController
  ...
  def create
    ...
    if @pokemon_trainer.save
      ...
      redirect_to pokemon_trainer_url(@pokemon_trainer), notice: t("faq.created")
    else
  ...
  def update
    ...
    if @pokemon_trainer.update(pokemon_trainer_params)
      redirect_to pokemon_trainer_url(@pokemon_trainer), notice: t("faq.updated")
    else
  ...
  def destroy
    ...
    redirect_to pokemon_trainers_url, notice: t("faq.destroyed")
  end
